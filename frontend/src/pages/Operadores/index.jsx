    ...
    <div className="operadores-page">
      ...
      <section className="section-table-cad">
        <table>
          <thead>
            <tr>
              <th className="table-name" onClick={handleSortByName}>Nome</th>
              <th className="table-matricula" onClick={handleSortByRegistration}>Matrícula</th>
          ...
          <tbody>
            {currentOperators.map(operator => (
              <tr key={operator.id}>
                ...
                <td>
                  <Button variant="primary" onClick={() => handleUpdate(operator.id)}>
                    Editar
                  </Button>
